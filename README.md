...
4. 代码创新点
 ...
 本项目基于参考来源的代码框架，进行了二次优化与创新，核心修改及优化点如下（重点优化姿态解算相关逻辑）：

- 姿态解算逻辑优化：参考UP主的姿态解算依赖MPU6050自带的DMP，我先弃用该库，自主编写互补滤波算法实现姿态解算；
  
- 后续进一步优化，重构姿态解算函数并引入卡尔曼滤波，修复设备长时间运行导致的姿态零偏问题，解决极限环震荡现象，大幅提升平衡车运行稳定性和姿态检测精度；

- 集成 vofa + 在线调参功能，支持实时参数调试，降低调试难度；

- 新增摇杆控制逻辑，扩展平衡车操控方式，提升使用灵活性；

- 优化电机驱动逻辑，增加电机死区补偿处理，改善电机运行平顺性，减少卡顿和误动作。
...
7.我会在我CSDN中更新对应的笔记和遇到的bug，感兴趣的可以关注一下：
